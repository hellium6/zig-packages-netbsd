...
BUILDLINK_API_DEPENDS.llvm+=	llvm21>=21.0.0
BUILDLINK_PKGSRCDIR.llvm?=	../../lang/llvm21
...
BUILDLINK_FILES.llvm+=		${LLVM_ISOLATED_PREFIX_BASENAME}/bin/llvm-cgdata
...
BUILDLINK_FILES.llvm+=		${LLVM_ISOLATED_PREFIX_BASENAME}/bin/llvm-ctxprof-util
