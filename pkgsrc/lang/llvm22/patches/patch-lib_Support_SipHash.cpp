...
Restore old code from LLVM 20 because build fails due to missing
"siphash/SipHash.h" (as tested on NetBSD 10.1)

--- lib/Support/SipHash.cpp.orig	2025-09-07 18:42:20.554600075 +0000
+++ lib/Support/SipHash.cpp
@@ -12,7 +12,6 @@
 //===----------------------------------------------------------------------===//
...
@@ -25,6 +24,135 @@ using namespace support;
