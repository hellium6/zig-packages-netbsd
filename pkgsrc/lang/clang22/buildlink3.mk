...
BUILDLINK_API_DEPENDS.clang+=	clang22>=22.1.8
BUILDLINK_ABI_DEPENDS.clang+=	clang22>=22.1.8
BUILDLINK_PKGSRCDIR.clang?=	../../lang/clang22
...
BUILDLINK_FILES.clang+=		${LLVM_ISOLATED_PREFIX_BASENAME}/bin/clang++
BUILDLINK_FILES.clang+=		${LLVM_ISOLATED_PREFIX_BASENAME}/bin/clang-22
...
.include "../../lang/llvm22/buildlink3.mk"
