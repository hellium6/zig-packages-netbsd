...
BUILDLINK_API_DEPENDS.clang+=	clang18>=18.0.0
BUILDLINK_ABI_DEPENDS.clang+=	clang18>=18.0.0
BUILDLINK_PKGSRCDIR.clang?=	../../lang/clang18
...
BUILDLINK_FILES.clang+=		${LLVM_ISOLATED_PREFIX_BASENAME}/bin/clang++
BUILDLINK_FILES.clang+=		${LLVM_ISOLATED_PREFIX_BASENAME}/bin/clang-18
